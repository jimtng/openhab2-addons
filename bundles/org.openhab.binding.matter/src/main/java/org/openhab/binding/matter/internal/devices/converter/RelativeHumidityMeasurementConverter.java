...
public class RelativeHumidityMeasurementConverter extends GenericConverter<RelativeHumidityMeasurementCluster> {
    ...
    public RelativeHumidityMeasurementConverter(RelativeHumidityMeasurementCluster cluster, EndpointHandler handler) {
    ...
    public Map<Channel, @Nullable StateDescription> createChannels(ThingUID thingUID) {
        Channel channel = ChannelBuilder
                ...
                .withLabel(CHANNEL_LABEL_HUMIDITYMEASURMENT_MEASUREDVALUE).build();
