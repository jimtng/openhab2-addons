...
public class GeneralCommissioningCluster extends BaseCluster {
    ...
    public class BasicCommissioningInfo {
         ...
         * safe timer can be re-armed. See Section 11.10.6.2.1, “Fail Safe Context”.
     ...
     * Fabric currently associated with the fail-safe context, then the fail-safe timer
     ...
     * cleanup behavior equivalent to that of fail-safe timer expiration as detailed in Section 11.10.6.2.2, “Behavior
     ...
     * the Fabric whose Fabric Index is recorded in the Fail-Safe context (see Section 11.10.6.2, “ArmFailSafe Command”)
     ...
     * (see Access Control Cluster) and operational credentials (see Section 6.4, “Node Operational Credentials
     * Specification”), and that the Node is reach
     ...
     * Section 6.6.2.8, “Bootstrapping of the Access Control Cluster”).
