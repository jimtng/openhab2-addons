...
public class ModeSelectCluster extends BaseCluster {
     ...
     * supported in this or any other cluster instance with the same value of this attribute. A
     * null value indicates no standard namespace, and therefore, no standard semantic tags are provided in this cluster
