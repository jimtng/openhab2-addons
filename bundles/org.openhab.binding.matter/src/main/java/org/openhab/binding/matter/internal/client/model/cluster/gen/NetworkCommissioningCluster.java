...
public class NetworkCommissioningCluster extends BaseCluster {
     ...
     * communicate with the node again (see Section 11.10.6.2, “ArmFailSafe Command”).
     ...
     * interface, whether by invocation of the ConnectNetwork command or by
     * autonomous connection after loss of connectivity or during initial establishment. If no such attempt was made, or
     ...
     * If this command is received without an armed fail-safe context (see Section 11.10.6.2, “ArmFailSafe Command”),
     ...
     * configuration if the CommissioningComplete command (see Section 11.10.6.6, “CommissioningComplete Command”) is
