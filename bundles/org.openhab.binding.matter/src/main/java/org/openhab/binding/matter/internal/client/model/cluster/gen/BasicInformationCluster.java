...
public class BasicInformationCluster extends BaseCluster {
     ...
     * The version number can be compared using a total ordering to determine if a version is logically newer than
     * another one. A larger value of SoftwareVersion is newer than a lower value, from the perspective of software
     * updates (see Section 11.20.3.3, “Availability of Software Images”). Nodes may query this field to determine the
    ...
    /**
     * This attribute shall specify a link to a product specific web page. The syntax of the ProductURL attribute shall
     * follow the syntax as specified in RFC 3986 [https://tools.ietf.org/html/rfc3986]. The specified URL SHOULD
     * resolve to a maintained web page available for the lifetime of the product. The maximum length of the ProductUrl
     ...
     * unchanging values and SHOULD NOT
