...
public class PumpConfigurationAndControlCluster extends BaseCluster {
    ...
    // Bitmaps
    public static class AlarmMask {
        /**
         * 
         * The device failed to complete initialization at powerup
         */
        public boolean initializationFailure;
        /**
         * 
        ...
        /**
         * 
         * The device was unable to complete self calibration
         */
        public boolean selfCalibrationFailure;

        public AlarmMask(boolean initializationFailure, boolean hardwareFailure, boolean selfCalibrationFailure) {
            this.initializationFailure = initializationFailure;
            this.hardwareFailure = hardwareFailure;
            this.selfCalibrationFailure = selfCalibrationFailure;
        }
    }
