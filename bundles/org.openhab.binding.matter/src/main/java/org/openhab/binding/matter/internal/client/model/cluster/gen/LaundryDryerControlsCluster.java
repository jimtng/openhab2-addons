...
public class LaundryDryerControlsCluster extends BaseCluster {
     ...
     * currently selected mode. The dryness level values are determined by the manufacturer. At least one dryness level
     * value shall be provided in the SupportedDrynessLevels list. The list of dryness levels may change depending on
     * the currently-selected Laundry Dryer mode.
     */
    public List<DrynessLevelEnum> supportedDrynessLevels; // 0 list
    /**
