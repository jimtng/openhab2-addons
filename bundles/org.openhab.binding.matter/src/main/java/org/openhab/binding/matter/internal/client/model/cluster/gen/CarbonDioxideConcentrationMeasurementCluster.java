...
public class CarbonDioxideConcentrationMeasurementCluster extends BaseCluster {
    ...
    public static final String CLUSTER_NAME = "CarbonDioxideConcentrationMeasurement";
    public static final int CLUSTER_ID = 0x040D;

    public CarbonDioxideConcentrationMeasurementCluster(BigInteger nodeId, int endpointId) {
