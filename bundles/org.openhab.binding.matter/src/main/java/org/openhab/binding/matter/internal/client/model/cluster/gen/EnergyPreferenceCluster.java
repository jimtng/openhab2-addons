...
public class EnergyPreferenceCluster extends BaseCluster {
     ...
     * of relative priorities. A Step field with a value of zero shall indicate that the device SHOULD entirely favor
     * the priority specified by the first element in EnergyPriorities; whereas a Step field with a value of 100 shall
     * indicate that the device SHOULD entirely favor the priority specified by the second element in EnergyPriorities.
     * The midpoint value of 50 shall indicate an even split between the two priorities.
